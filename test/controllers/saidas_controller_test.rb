...
class SaidasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create saida" do
    assert_difference('Saida.count') do
      post saidas_url, params: { saida: { data: @saida.data, descricao: @saida.descricao, valor: @saida.valor } }
    end
  ...
  test "should update saida" do
    patch saida_url(@saida), params: { saida: { data: @saida.data, descricao: @saida.descricao, valor: @saida.valor } }
